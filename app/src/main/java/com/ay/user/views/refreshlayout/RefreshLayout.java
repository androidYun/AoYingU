 ...
 * <p>
 * This item_my_wdwz should be made the parent of the view that will be refreshed as a
 * result of the gesture and can only support one direct child. This view will
 * also be made the target of the gesture and will be forced to match both the
 * width and the height supplied in this item_my_wdwz. The SwipeRefreshLayout does not
...
public class RefreshLayout extends ViewGroup {
     ...
     * swipe to refresh item_my_wdwz. This is not valid until a measure pass has
     * completed.
     *
    ...
    /**
     * @return Whether it is possible for the child view of this item_my_wdwz to
