package com.ay.user.utils;

import android.content.Context;
import android.content.SharedPreferences;

import com.ay.user.MainApplication;
...
public class SPUtil {
     ...
     * 保存在手机里面的文件名
     */
    public static final String FILE_NAME = "USER_INFOR";
    ...
    public static void putBean(Context context, String key,
        ...
        String objString = JsonUtil.toJson(obj);// fastjson的方法，需要导包的
    ...
    public static <T> T getBean(Context context, String key,
        ...
        try {
            return JsonUtil.fromJson(objString, clazz);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return null;
